...
bool hesai_ros_driver__msg__udp_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hesai_ros_driver.msg._udp_packet.UdpPacket", full_classname_dest, 42) == 0);
  }
  hesai_ros_driver__msg__UdpPacket * ros_message = _ros_message;
  {  // stamp
...
PyObject * hesai_ros_driver__msg__udp_packet__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hesai_ros_driver.msg._udp_packet");
