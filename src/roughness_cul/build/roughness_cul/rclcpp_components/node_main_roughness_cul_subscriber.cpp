...
#define NODE_MAIN_LOGGER_NAME "roughness_cul_subscriber"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libroughness_cul.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<roughness_cul::LiDAR_sub>";
